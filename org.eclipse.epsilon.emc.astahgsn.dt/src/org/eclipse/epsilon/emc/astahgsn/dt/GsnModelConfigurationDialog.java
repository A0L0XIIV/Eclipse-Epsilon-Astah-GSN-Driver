 ...
 ******************************************************************************/
package org.eclipse.epsilon.emc.astahgsn.dt;

import org.eclipse.epsilon.common.dt.launching.dialogs.AbstractCachedModelConfigurationDialog;
import org.eclipse.epsilon.emc.astahgsn.GsnModel;
...
public class GsnModelConfigurationDialog extends AbstractCachedModelConfigurationDialog {
	...
	protected Composite createFilesGroup(Composite parent) {
		...
		browseModelFile.addListener(SWT.Selection, new BrowseWorkspaceForModelsListener(fileText, "XMI Documents in the workspace", "Select an XML document"));
	...
	protected void loadProperties(){
		...
		fileText.setText(properties.getProperty(GsnModel.PROPERTY_FILE));
		uriText.setText(properties.getProperty(GsnModel.PROPERTY_URI));
	...
	protected void storeProperties(){
		...
		properties.put(GsnModel.PROPERTY_URI, uriText.getText());
		properties.put(GsnModel.PROPERTY_FILE, fileText.getText());
